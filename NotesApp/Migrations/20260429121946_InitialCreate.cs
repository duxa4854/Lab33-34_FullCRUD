        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "#3498db", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Конспекты и материалы для обучения", "Учеба" },
                    { 3, "#2ecc71", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Личное заметки и идеи", "Личное" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Пройти лабораторные работы 27-36 ", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, true, 5, "Изучение ASP.NET Core", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
